        ...
        children: [
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                            children: [
                              Text('+7(3852)-210-74-43', style: TextStyle(color: kTextColor, fontSize:kDesktopSize * 2.5),),
                    ...
                    Row(
                      ...
                      children: [IconCont(
                        ...
                        Text('vk.com/mig_service22', style: TextStyle(color: kTextColor, fontSize:kDesktopSize * 2.5),),]),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [IconCont(
                        kSize: kSize,
          ...
          Expanded(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text('г. Барнаул,', style: TextStyle(color: kTextColor, fontSize: kSize * 5 ),),
                    Text('пр. Красоармейский 4', style: TextStyle(color: kTextColor, fontSize: kSize * 4 ),),
                    Expanded(
                      child: ListView(
                          children:[
                            Container(
